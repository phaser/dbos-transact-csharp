...
public sealed class ListQueuedWorkflowsRequest : BaseMessage
{
    [JsonPropertyName("body")]
    public QueuedWorkflowsBody? Body { get; set; }

    public ListQueuedWorkflowsRequest() { Type = MessageType.ListQueuedWorkflows.GetValue(); }

    public sealed class QueuedWorkflowsBody
    {
